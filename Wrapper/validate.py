...
def checkjson(file):
	return 'smc_iterations' in file == True
...
print(checkjson(parsed.json))





	#data = json.load(parsed.json)
# else:
# 	print('The file must be a json extension')





# 			if 'smc_iterations' and 'num_samples'\
# 				and 'database_filename' and 'parameters'\
# 				and 'metrics' in data:
# 				print('Is in data')
# 				pass
# 			else:
